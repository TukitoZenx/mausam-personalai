...
export const CONFIG: AppConfig = {
  ...
  APK_URL: "", // When you publish an APK release, set the URL here (e.g. "https://github.com/TukitoZenx/mausam-personalai/releases/download/v1.0.0/mausam-release.apk")
